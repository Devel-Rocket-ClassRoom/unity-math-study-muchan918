...
public class Assignment_GachaSimulator : MonoBehaviour
{
    ...
    private bool ExecutePull()
    {
        ...
        else if (currentPityCount < hardPity - 1)
        {
            ...
            currentEffectiveRate = baseRate + rateIncrease * (currentPityCount - softPityStart + 1);
        }
        else
        {
        ...
        // if (currentPityCount >= softPityStart)
        // {
        //     increase = (1f - baseRate) / (hardPity - softPityStart) * (currentPityCount - softPityStart);
        // }
        // currentEffectiveRate = baseRate + increase;
